...
#
        ...
        panos_send_commands(panos_connection, command_type='configure', commands=[
            ...
            'set template sdwan-template config  network virtual-router corp protocol bgp routing-options graceful-restart enable yes',
            'set template sdwan-template config  network virtual-router corp protocol bgp enable no',
            'set template sdwan-template config  network virtual-router corp protocol rip enable no',
            'set template sdwan-template config  network virtual-router corp protocol ospf enable no',
            'set template sdwan-template config  network virtual-router corp protocol ospfv3 enable no',
